...
extension UInt2X : CustomStringConvertible, CustomDebugStringConvertible {
    public func toString(radix:Int=10, uppercase:Bool=false) -> String {
        ...
        if self.hi == 0 {
            return String(self.lo, radix:radix, uppercase:uppercase)
        }
        ...
        let digits = uppercase
            ...
            : Array("0123456789abcdefghijklmnopqrstuvwxyz")
        if self.bitWidth < 64 { // slow but steady digit by digit conversion
            ...
            let (base, nlen) = [
                ...
                (0x8000000000000000, 63),   //  2
                (0xA8B8B452291FE821, 40),   //  3
                (0x4000000000000000, 31),   //  4
                (0x6765C793FA10079D, 27),   //  5
                (0x41C21CB8E1000000, 24),   //  6
                (0x3642798750226111, 22),   //  7
                (0x8000000000000000, 21),   //  8
                (0xA8B8B452291FE821, 20),   //  9
                (0x8AC7230489E80000, 19),   // 10
                (0x4D28CB56C33FA539, 18),   // 11
                (0x1ECA170C00000000, 17),   // 12
                (0x780C7372621BD74D, 17),   // 13
                (0x1E39A5057D810000, 16),   // 14
                (0x5B27AC993DF97701, 16),   // 15
                (0x1000000000000000, 15),   // 16
                (0x27B95E997E21D9F1, 15),   // 17
                (0x5DA0E1E53C5C8000, 15),   // 18
                (0xD2AE3299C1C4AEDB, 15),   // 19
                (0x16BCC41E90000000, 14),   // 20
                (0x2D04B7FDD9C0EF49, 14),   // 21
                (0x5658597BCAA24000, 14),   // 22
                (0xA0E2073737609371, 14),   // 23
                (0x0C29E98000000000, 13),   // 24
                (0x14ADF4B7320334B9, 13),   // 25
                (0x226ED36478BFA000, 13),   // 26
                (0x383D9170B85FF80B, 13),   // 27
                (0x5A3C23E39C000000, 13),   // 28
                (0x8E65137388122BCD, 13),   // 29
                (0xDD41BB36D259E000, 13),   // 30
                (0x0AEE5720EE830681, 12),   // 31
                (0x1000000000000000, 12),   // 32
                (0x172588AD4F5F0981, 12),   // 33
                (0x211E44F7D02C1000, 12),   // 34
                (0x2EE56725F06E5C71, 12),   // 35
                (0x41C21CB8E1000000, 12)    // 36
            ][radix]
            //print("base=\(base),nlen=\(nlen)")
            var qr = (quotient: self, remainder: UInt2X(0))
            var result = [UInt64]()
            repeat {
